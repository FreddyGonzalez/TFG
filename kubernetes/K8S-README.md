...
```
$ docker image tag comentario gcr.io/jhipster-kubernetes-323618/comentario
$ gcloud docker push gcr.io/jhipster-kubernetes-323618/comentario
$ docker image tag factura gcr.io/jhipster-kubernetes-323618/factura
$ gcloud docker push gcr.io/jhipster-kubernetes-323618/factura
$ docker image tag notificacion gcr.io/jhipster-kubernetes-323618/notificacion
$ gcloud docker push gcr.io/jhipster-kubernetes-323618/notificacion
$ docker image tag producto gcr.io/jhipster-kubernetes-323618/producto
$ gcloud docker push gcr.io/jhipster-kubernetes-323618/producto
$ docker image tag tienda gcr.io/jhipster-kubernetes-323618/tienda
$ gcloud docker push gcr.io/jhipster-kubernetes-323618/tienda
```
...
```
$ kubectl get svc tienda -n jhipster
```
