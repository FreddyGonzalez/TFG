...
import com.tfg.factura.web.rest.errors.BadRequestAlertException;
...
/**
 * REST controller for managing {@link com.tfg.factura.domain.Envio}.
 */
@RestController
@RequestMapping("/api")
public class EnvioResource {
    ...
    private static final String ENTITY_NAME = "facturaEnvio";
