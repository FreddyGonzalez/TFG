package com.tfg.notificacion.config;
...
public class CacheConfiguration {
    ...
    public HazelcastInstance hazelcastInstance(JHipsterProperties jHipsterProperties) {
        ...
        HazelcastInstance hazelCastInstance = Hazelcast.getHazelcastInstanceByName("notificacion");
        if (hazelCastInstance != null) {
            log.debug("Hazelcast already initialized");
            return hazelCastInstance;
        }
        Config config = new Config();
        config.setInstanceName("notificacion");
        ...
        config.getMapConfigs().put("com.tfg.notificacion.domain.*", initializeDomainMapConfig(jHipsterProperties));
