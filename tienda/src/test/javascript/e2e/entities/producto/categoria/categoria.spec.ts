...
describe('Categoria e2e test', () => {
  ...
  it('should load Categorias', async () => {
    ...
    expect(await categoriaComponentsPage.getTitle()).to.eq('tiendaApp.productoCategoria.home.title');
  ...
  it('should load create Categoria page', async () => {
    ...
    expect(await categoriaUpdatePage.getPageTitle()).to.eq('tiendaApp.productoCategoria.home.createOrEditLabel');
  ...
  it('should create and save Categorias', async () => {
    ...
    await promise.all([categoriaUpdatePage.setNombreInput('nombre'), categoriaUpdatePage.setDescripcionInput('descripcion')]);
  ...
  it('should delete last Categoria', async () => {
    ...
    expect(await categoriaDeleteDialog.getDialogTitle()).to.eq('tiendaApp.productoCategoria.delete.question');
