...
describe('Producto e2e test', () => {
  ...
  it('should load Productos', async () => {
    ...
    expect(await productoComponentsPage.getTitle()).to.eq('tiendaApp.productoProducto.home.title');
  ...
  it('should load create Producto page', async () => {
    ...
    expect(await productoUpdatePage.getPageTitle()).to.eq('tiendaApp.productoProducto.home.createOrEditLabel');
  ...
  it('should create and save Productos', async () => {
    ...
    expect(await productoUpdatePage.getImagenInput()).to.endsWith(
      fileNameToUpload,
      'Expected Imagen value to be end with ' + fileNameToUpload
    );
  ...
  it('should delete last Producto', async () => {
    ...
    expect(await productoDeleteDialog.getDialogTitle()).to.eq('tiendaApp.productoProducto.delete.question');
