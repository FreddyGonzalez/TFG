...
public class ClienteResourceIT {
    ...
    private static final String DEFAULT_EMAIL = "qCXDM@X!dS'H.\\DH(6";
    private static final String UPDATED_EMAIL = "q@DqD.WIX2$'";
     ...
     *
     * @see com.tfg.tienda.repository.search.ClienteSearchRepositoryMockConfiguration
     */
    @Autowired
    ...
    public void updateCliente() throws Exception {
        ...
        // Validate the Cliente in Elasticsearch
        verify(mockClienteSearchRepository, times(2)).save(testCliente);
    }
