...
export class ComentarioService {
  public resourceUrl = SERVER_API_URL + 'services/comentario/api/comentarios';
  public resourceSearchUrl = SERVER_API_URL + 'services/comentario/api/_search/comentarios';
  ...
  search(req: SearchWithPagination): Observable<EntityArrayResponseType> {
    const options = createRequestOption(req);
    return this.http.get<IComentario[]>(this.resourceSearchUrl, { params: options, observe: 'response' });
  }
}
